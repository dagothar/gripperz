...
namespace gripperz {
    namespace simulation {
        ...
        public:
             ...
             */
            GraspTaskSimulator(rwsim::dynamics::DynamicWorkCell::Ptr dwc, int nrThreads = 1, const std::string& engine = "ODE");
            ...
            size_t getNrTargets();
            rwsim::simulator::ThreadSimulator::Ptr getSimulator();
            ...
            typedef enum {
                GRASPING, LIFTING, NEW_GRASP, APPROACH
            } StepState;
