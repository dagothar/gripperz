...
void TaskDescriptionLoader::readAlignment(rwlibs::xml::PTree& tree, TaskDescription::Ptr task)
{
	...
	TaskDescription::AlignmentModelParameters& pose0params = task->_stablePose0DParameters;
	...
	// read pose 0D parameters
	TaskDescription::AlignmentModelParameters& pose1params = task->_stablePose1DParameters;
...
void TaskDescriptionLoader::save(const TaskDescription::Ptr td, const std::string& filename)
{
	...
	{
		PTree node0;
		node0.put("Iterations", boost::lexical_cast<string>(td->_stablePose0DParameters.iterations));
		node0.put("MinInliers", boost::lexical_cast<string>(td->_stablePose0DParameters.minInliers));
		node0.put("DataThreshold", boost::lexical_cast<string>(td->_stablePose0DParameters.dataThreshold));
		node0.put("ModelThreshold", boost::lexical_cast<string>(td->_stablePose0DParameters.modelThreshold));
		node0.put("Weight", boost::lexical_cast<string>(td->_stablePose0DParameters.weight));
		
		PTree node1;
		node1.put("Iterations", boost::lexical_cast<string>(td->_stablePose1DParameters.iterations));
		node1.put("MinInliers", boost::lexical_cast<string>(td->_stablePose1DParameters.minInliers));
		node1.put("DataThreshold", boost::lexical_cast<string>(td->_stablePose1DParameters.dataThreshold));
		node1.put("ModelThreshold", boost::lexical_cast<string>(td->_stablePose1DParameters.modelThreshold));
		node1.put("Weight", boost::lexical_cast<string>(td->_stablePose1DParameters.weight));
